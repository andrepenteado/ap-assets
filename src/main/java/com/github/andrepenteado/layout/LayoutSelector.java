        ...
        class SkinDecoratorSelector implements DecoratorSelector<WebAppContext> {
            ...
            public String[] selectDecoratorPaths(Content content, WebAppContext context) throws IOException {
                ...
                if (jspDecorator == null) {
                    ...
                    if (jspDecorator == null)
                        jspDecorator = context.getRequest().getSession().getAttribute("decorator") != null
                                        ? context.getRequest().getSession().getAttribute("decorator").toString() : null;
                ...
                //  <param-value>ap-bootstrap3</param-value>
                //</context-param>
                ...
                return PATH_LAYOUTS.concat(skinDecorator).concat("/").concat(jspDecorator).concat(".jsp").split(",");
            }
        }
